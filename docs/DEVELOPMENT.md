...
Technical reference for working on the Alt-Tab website. This covers local
setup, project structure, adding pages and content, and deployment.
...
The bottom ticker text lives in the `MARQUEE_ITEMS` array near the top of
`src/App.jsx`. Edit that array to change what scrolls across the bar.
